// TO write a program to multiply two matrices using a user defined function
void matrixmultiply(int mat1[5][5], int mat2[5][5], int mat3[5][5]);
int r1,c1,c2;
#include<stdio.h>
int main()
{
    ...
    scanf ("%d%d",&r2,&c2);
    if (c1!=r2)
    printf ("Multiplication of matrices not possible,enter matrixes of equal size\n");
    else
    {
